...
| `apps/admin/src/fsd/pages/pipeline/model/{journey,briefing,desk-commands,sprites}.ts` + `ui/**` | `src/fsd/pages/project-board/` | 최신 DB 행을 직접 받아 Activity·Team을 만든다. 날짜 섹션 왕복과 미사용 발화·아바타 모델 제거. journey 제거(`a9b4bf2`) |
